...
import pappaSrc from '../assets/pappa-contact.png'
        ...
        <section className="where">
            <div className="container">
                ...
                <div className="where__text-content">
                    <p>
                        Lorem ipsum dolor sit amet, consectetur adipisicing elit. Eos reiciendis hic atque totam! Doloremque itaque fuga iusto incidunt veritatis ipsam!
                    </p>
                        ...
                        <div className="content__item-container">
                            ...
                            <div className="content__item item">
                                <svg width="17" height="17" viewBox="0 0 17 17" fill="none" xmlns="http://www.w3.org/2000/svg">
                                    <g clip-path="url(#clip0_1650_4592)">
                                        <path
